...
class Booking
{
    ...
    /**
     * Callback when creating a reservation
     *
     * @ORM\PrePersist
     * @ORM\PreUpdate
     * 
    ...
    {
        // 1. You need to know the impossible dates for the ad
        $notAvailableDays = $this->ad->getNotAvailableDays();
        // 2. Compare dates chosen with impossible dates
    ...
    /**
     * Allows to retrieve a array of the days that correspond to my reservation
     *
